    ...
    <section class="section dashboard">
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Programs offered in Admissions</h5>
              <p>The following table consist of Programs for which a candidate can apply.</p>
              ...
              <table class="table datatable">
                <thead>
                  <tr>
                    ...
                    <th scope="col">BSC/etc. Percentage</th>
                    <th scope="col">BSC/etc. Division</th>
               ...
               while ($row=mysqli_fetch_assoc($result)) {
                ?>
                  <tr>
                    ...
                    <td><?php echo $row['inter-percent']; ?></td>
                    <td><?php echo $row['inter-division']; ?></td>
                    <td><?php echo $row['bsc-percent']; ?></td>
                    <td><?php echo $row['bsc-division']; ?></td>
