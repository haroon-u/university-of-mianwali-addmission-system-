    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-6">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title ">Candidates Educational Degrees-<br> Rules/Details/Edit<br>(Already in Database)</h5>
              ...
              <!-- General Form Elements -->
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <form id="test1">
                      <select class="form-select" aria-label="select_degree" id="select_degree">
                ...
                <form id="degree_details" class="mt-5">
                  <!-- 
                  <hr> <h5 class="text-center">Details & Edit</h5>
                 <div class="row mb-3">
                  <label class="col-sm-2 col-form-label">Type</label>
                  <div class="col-sm-10">
                    <select class="form-select" aria-label="Default select example" id="certificate">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    ...
                    <div class="form-check">
                      <input class="form-check-input" type="checkbox" id="gridCheck1" value="">
                    ...
                    <div class="form-check">
                      <input class="form-check-input" type="checkbox" id="gridCheck2" value="">
        ...
        <div class="col-lg-6">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">ADD NEW (Certificate/Degree)</h5>
              ...
              <form id="add_degree">
                <hr> <h5 class="text-center">Details & Edit</h5>
                 <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <select class="form-select" aria-label="cname" id="cname" name="cname" required>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10" id="departments" >
